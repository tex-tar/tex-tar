...
class DocLevelDataset_RoPE_Train(Dataset):
    def __init__(self,order_list,img_dir,label_split,total_categories,transform=None):
        ...
        self.bbjson_path = "/data/textar_outputs/jsons/generate_bbox.json"
...
class DocLevelDataset_RoPE_Val_name(Dataset):
    def __init__(self,order_list,img_dir,label_split,total_categories,transform=None):
        ...
        self.label_split = label_split
        self.total = total_categories
        #self.bbjson_path = "/ssd_scratch/rohan/swaroopajinka/hisam_outputs/val_hisam_verified.json"
        self.bbjson_path = "/ssd_scratch/rohan.kumar/swaroopajinka/corpus_augmented_decreased_underlines/val/labels/val_augmented.json"
